...
`causeinfer` is available for installation via [uv](https://docs.astral.sh/uv/) (recommended) or [pip](https://pypi.org/project/causeinfer/).
...
Create a virtual environment for causeinfer (Python `>=3.12`), activate it and install dependencies.
